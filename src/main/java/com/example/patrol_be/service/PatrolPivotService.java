...
public class PatrolPivotService {
    ...
    public PatrolRiskPivotResponseDTO getPivot(String plant, List<String> atStatuses, String type) {
        List<Object[]> raw = repo.pivotByPicAndRisk(plant, atStatuses, type);
